# AGENTS.md instructions for /home/christorng/audio-browser-kiro
...
<environment_context>
  <cwd>/home/christorng/audio-browser-kiro</cwd>
...
<environment_context>
  ...
  <network_access>restricted</network_access>
  <writable_roots>
    <root>/home/christorng/audio-browser-kiro</root>
  </writable_roots>
  <shell>bash</shell>
</environment_context>
...
## Active file: scripts/gen_visuals.py

## Open tabs:
- gen_visuals.py: scripts/gen_visuals.py
- USER_PROMPT.md: USER_PROMPT.md
- visualizationService.ts: src/server/services/visualizationService.ts
- visualizationRoutes.ts: src/server/routes/visualizationRoutes.ts
- visualizationService.test.ts: tests/server/services/visualizationService.test.ts

## My request for Codex:
網站啟動時掃描 config.json 中指定的目標資料夾時，不掃描隱藏資料夾。
